    ...
    <main class="login-register-main">
        <div class="login-register-wrapper">
            <div id="login-welcome-wrapper">
                ...
                <p>¡Te damos la bienvenida! si ya tienes una cuenta, inicia sesión para acceder a tu perfil.</p>
            </div>

            <form action="./scripts/iniciar_sesion.asp" method="post" class="login-register-form">
                ...
                <div class="form-section-wrapper" id="submit-btn-wrapper">
                    <input type="submit" name="submit" class="btn btn-primary" id="submit" value="Inicia sesión">
                </div>
            </form>
            <div id="error_message_wrapper">
                <p id="error_message">
                <%
                    error_cookie = Request.Cookies("error_login")   
                    If error_cookie = "true" Then
                        Response.Write "Usuario o contraseña incorrectos"
                    End If
                    response.cookies("error_login") = "false"
                %>    
                </p>
            </div>
            ...
            <div id="opposite-action-wrapper">
                ...
                <button class="btn btn-terciary" id="opposite-action-btn" onclick=" ">Crea tu cuenta</button>
            </div>
        </div>
